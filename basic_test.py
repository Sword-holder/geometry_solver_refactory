...
def get_problem():
    ...
    angle_a = Angle('A', side1=line_ab, side2=line_ac, vertex=p_a)
    angle_b = Angle('B', side1=line_ab, side2=line_bc, vertex=p_b)
    angle_c = Angle('C', side1=line_ac, side2=line_bc, vertex=p_c)
